...
{
public:
	//IsEmpty: returns whether first node is NULL.
	...
	//Overload+ operator:  includes the ‘+” operator as a member function without chaining to add word B     
	...
	//Default Constructor: initialize state variables. 
